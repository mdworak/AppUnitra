...
public class DatabaseWZ extends SQLiteOpenHelper {
    public DatabaseWZ(Context context) {
        super(context, "wz.db", null, 1);
    }
    ...
    public void addWZ(DataWZ data){
        ...
        values.put("pobor_mocy", data.getPobor_mocy());
        ...
        db.insertOrThrow("wz",null, values);
    }

    public List<DataWZ> getAll(){
        List<DataWZ> contacts = new LinkedList<DataWZ>();
        String[] columns={"nazwa","producent","rodzaj","moc","lampy","rok_produkcji","pobor_mocy","pasmo_przenoszenia","wymiary","waga"};
        SQLiteDatabase db = getReadableDatabase();
        Cursor cursor =db.query("wz",columns,null,null,null,null,null,null);
        while(cursor.moveToNext()){
            DataWZ data = new DataWZ();
            ...
            data.setPobor_mocy(cursor.getString(6));
            data.setPasmo_przenoszenia(cursor.getString(7));
    ...
    public String getModel(String name){
        ...
        String args[]={name+""};
        Cursor cursor=db.query("wz",columns,"nazwa=?",args,null,null,null,null);
        String model=null;
        if(cursor!=null){
            cursor.moveToFirst();
    ...
    public String getNazwa(String id){
        ...
        String[] columns={"nazwa"};
        String args[]={id+""};
        Cursor cursor=db.query("wz",columns,"id=?",args,null,null,null,null);
        String model=null;
        if(cursor!=null){
            cursor.moveToFirst();
            model = cursor.getString(0);
    ...
    public List<DataWZ> getDane(String id){
        List<DataWZ> contacts = new LinkedList<DataWZ>();
        String[] columns={"nazwa","producent","rodzaj","moc","lampy","rok_produkcji","pobor_mocy","pasmo_przenoszenia","wymiary","waga"};
        SQLiteDatabase db = getReadableDatabase();
        Cursor cursor = db.rawQuery(
                "SELECT nazwa,producent,rodzaj,moc,lampy,rok_produkcji,pobor_mocy,pasmo_przenoszenia,wymiary,waga  FROM  wz WHERE id='"+id+"'" , null);
    ...
    public int getID(String nazwa) {
        ...
        Cursor mCursor = db.rawQuery(
                "SELECT id  FROM  wz WHERE nazwa='"+nazwa+"'" , null);
    ...
    public String[] getZdjecia(String id){
        ...
        SQLiteDatabase db = getReadableDatabase();
        Cursor cursor = db.rawQuery(
                "SELECT zdjecie1,zdjecie2,zdjecie3  FROM  wz WHERE id='"+id+"'" , null);
        cursor.moveToFirst();
